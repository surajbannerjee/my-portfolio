...
export default function InnerHeadline({
  ...
  title,
  description,
  paddingClass = "padding-text-pre-block",
  colSize = "col-xl-8",
  extraContent,
}) {
  return (
    <div className={`mxd-section mxd-section-inner-headline ${paddingClass}`}>
        ...
        <div className="mxd-block loading-wrap">
          <div className="container-fluid px-0">
            <div className="row gx-0">
              ...
              <div className={`col-12 ${colSize} mxd-grid-item no-margin`}>
